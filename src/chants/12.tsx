    ...
    <div>
      ...
      <div className="byz--neume-paragraph">
        ...
        <x-n>
          ...
          <x-var></x-var>
          <x-i></x-i>
          <x-ii-ke className="byz--ii"></x-ii-ke>
          <x-ly>не</x-ly>
          <x-mel a h></x-mel>
        </x-n>
        <x-n>
        ...
        <x-n>
          <x-o></x-o>
          <x-f-hc-pa className="byz--f"></x-f-hc-pa>
          <x-ly>по</x-ly>
          <x-mel a h></x-mel>
        </x-n>
        <x-n>
        ...
        <x-n>
          ...
          <x-o></x-o>
          <x-kl></x-kl>
          <x-f-agem-b className="byz--f"></x-f-agem-b>
          <x-ly>тлен</x-ly>
          <x-mel a h></x-mel>
        </x-n>
        <x-n>
